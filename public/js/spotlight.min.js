...
(function() {
  ...
  function f (a, b) {
    ...
    if (a.length) for (var d = 0; d < a.length; d++) (c ? ca : da)(a[d], b) else (c ? ca : da)(a, b)
  }
  ...
  function h (a, b) {
    a = g(a)
    var c = 'string' === typeof b
    if (a.length) for (var d = 0; d < a.length; d++) (c ? ea : fa)(a[d], b) else (c ? ea : fa)(a, b)
  }
  ...
  function l (a, b, c, d) {
    ...
    if (a.length) for (var k = 0; k < a.length; k++) (e ? ha : ia)(a[k], b, e || c, d) else (e ? ha : ia)(a, b, e || c, d)
  }
  ...
  function n (a, b) {
    ...
    return !1
  }var p = 'theme fullscreen autofit zoom-in zoom-out page title description player progress'.split(' '), q, r, oa, pa,
    u, v, y, z, A, B, C, D, E, F, qa, ra, G, H, I, J, sa, ta, ua, K, L, N, va, O, wa, xa, ya, za, Ba, P, Ca, Da, Ea, Q,
    R, Fa, S, T, U, Ga
  ...
  function Ha (a, b) {
    if (H = a.length) {
      ...
      for (var k = 0; k < H; k++) {
        ...
        x = void 0
        var M = U, jb = k, kb = w && (w.href || w.src) || t.src || t.href, Aa;
        (Aa = w && w.title || t.title) || (Aa = (x = (t || document).getElementsByTagName('img')).length && x[0].alt)
        M[jb] = {
          src: kb, title: Aa || d || '', description: w && w.description || t.description || e ||
            '',
        }
      }
      G = b || 1
  ...
  function Qa () {
    Ra || (O = document.createElement('div'), O.id = 'spotlight', O.innerHTML = '<div class=preloader></div><div class=scene><div class=pane></div></div><div class=header><div class=page></div><div class="icon fullscreen"></div><div class="icon autofit"></div><div class="icon zoom-out"></div><div class="icon zoom-in"></div><div class="icon theme"></div><div class="icon player"></div><div class="icon close"></div></div><div class=progress></div><div class="arrow arrow-left"></div><div class="arrow arrow-right"></div><div class=footer><div class=title></div><div class=description></div></div>',
      ...
      T.webkitRequestFullScreen || T.msRequestFullScreen || T.mozRequestFullScreen || l(P, 'display', 'none') || function() {
      }), Ga = [[window, 'keydown', Sa], [window, 'wheel', Ta], [window, 'hashchange', Ua], [window, 'resize', Va], [Q, 'mousedown', Wa], [Q, 'mouseleave', Xa], [Q, 'mouseup', Xa], [Q, 'mousemove', Ya], [Q, 'touchstart', Wa, { passive: !1 }], [Q, 'touchcancel', Xa], [Q, 'touchend', Xa], [Q, 'touchmove', Ya, { passive: !0 }], [P, '', Za], [za, '', $a], [Ba, '', W], [Da, '', ab], [V('autofit'), '', bb], [V('zoom-in'), '', cb], [V('zoom-out'), '', db], [V('close'), '',
      eb], [V('theme'), '', Na]], Ra = !0)
  }
  ...
  function Pa (a) {
    ...
    if (b) {
      var c = hb.call(b, '.spotlight-group'), d = (c || document).getElementsByClassName('spotlight')
  ...
  function bb (a) {
    ...
    F = 1 === A && !F
    l(N, { maxHeight: F ? 'none' : '', maxWidth: F ? 'none' : '', transform: '' })
    y = N.width
    z = N.height
    A = 1
    r = q = 0
  ...
  function lb () {
    ...
    l(Ea, { transitionDuration: ua + 'ms', transform: 'translateX(0)' })
  }
  ...
  function Ja (a) {
    ...
    e && l(N, { visibility: 'visible', opacity: 1, transform: '' })
    x && h(N, x)
    X()
